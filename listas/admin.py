...
from .models import Bodegas,Bodegagenericos,Bodegaotrasmarcas,Bodegariester,Salida,Producto,DetSalida
...
class Bodegaadmin(ImportExportModelAdmin,admin.ModelAdmin):
...
admin.site.register(Bodegagenericos)
admin.site.register(Bodegariester)
admin.site.register(Bodegaotrasmarcas)
