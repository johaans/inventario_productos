...
from listas.views import Bodegas_ListView,BodegaCreateView,BodegaUpdateView,BodegaDeleteView
...
urlpatterns = [
    path('lista/repuestos/',Bodegas_ListView.as_view(), name='lista_repuestos'),
    path('lista/repuestos2/',Bodegas_ListView.as_view(), name='lista_categorias'),
    path('lista/crear/',BodegaCreateView.as_view(), name='crear_bodega'),
    path('lista/editar/<int:pk>/',BodegaUpdateView.as_view(), name='editar_bodega'),
    path('lista/borrar/<int:pk>/',BodegaDeleteView.as_view(), name='borrar_categoria'),
